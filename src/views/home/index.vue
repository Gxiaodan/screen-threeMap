<template>
  <div class="container">
    ...
    <div class="main-con">
      <div class="wheel-con">
        <div
          v-for="(item, index) in wheelData"
          :key="index"
          class="sub-tit"
          :class="{
            active: index == curIndex,
            lastActive: (index + 1) % wheelData.length == curIndex,
          }"
        >
          <div
            v-if="
              index == curIndex || (index + 1) % wheelData.length == curIndex
            "
          >
    ...
    <div id="canvas_content">
      ...
      <div
        v-for="(label, index) in labelDatas"
        :key="index"
        :id="label.id"
        class="fixed-label"
      >
    ...
    return {
      ...
      labelDatas: [
        ...
        },
        {
          name: "徐州",
          value: 100,
          coordinates: [117.2, 34.26],
          id: "label-002",
        },
        {
          name: "遵义",
          value: 200,
          coordinates: [116.9, 27.7],
          id: "label-003",
        },
        {
          name: "和田",
          value: 250,
          coordinates: [79.94, 37.12],
          id: "label-004",
        },
        {
          name: "杭州",
